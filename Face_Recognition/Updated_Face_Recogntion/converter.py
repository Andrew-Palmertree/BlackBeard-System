...
vggface_resnet = VGGFace('Updated_ResNet50_with_New_Person_With_Hannah.h5')

# Load a custom model
custom_vgg_model = keras.models.load_model("Updated_ResNet50_with_New_Person_With_Hannah.h5")
...
with open('updated_vggface_resnet50_tflite_64bit', 'wb') as f:
